...
async function getTemplateHTML(selected, params, isMailToLogistic = false) {
    return new Promise((resolve, reject) => {
        ...
        const {plan, email, password, code, customer_phone, patient_first_name, patient_last_name, customer_name, customer_email, shipping_address, shipping_city, vendor, support_network_name, company_client, type_alert, user_id, id_smartwatch, sw_number, location, event_date, success_url} = params;
        ...
        fs.readFile(filePath, 'utf8', (err, data) => {
            ...
            modifiedHTML = customer_name ? modifiedHTML.replace('%RED_PLAN%', plan) : modifiedHTML;
